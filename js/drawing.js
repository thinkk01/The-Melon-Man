...
game.drawPlayer = function () {
  let currentFrame =
    game.player.animations2[game.player.direction][
      game.player.animationFrameNumber % 10
    ];
  let sourceX = currentFrame.X * game.player.animations2.sliceWidth;
  let sourceY = currentFrame.Y * game.player.animations2.sliceHeight;
  game.context.drawImage(
    game.ninja,
    sourceX,
    sourceY,
    game.player.animations2.sliceWidth,
    game.player.animations2.sliceHeight,
    Math.round(game.options.canvasWidth / 2 - game.options.tileWidth / 2),
    Math.round(game.options.canvasHeight / 2 - game.options.tileHeight / 2),
    game.options.tileWidth,
    game.options.tileHeight
